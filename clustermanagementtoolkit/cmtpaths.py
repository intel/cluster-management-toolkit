...
SYSTEM_ANSIBLE_PLAYBOOK_DIR = FilePath(os.path.join(SYSTEM_DATA_DIR, ANSIBLE_PLAYBOOK_DIRNAME))
SYSTEM_PARSERS_DIR = FilePath(os.path.join(SYSTEM_DATA_DIR, PARSER_DIRNAME))
SYSTEM_SOFTWARE_SOURCES_DIR = FilePath(os.path.join(SYSTEM_DATA_DIR, SOFTWARE_SOURCES_DIRNAME))
SYSTEM_THEMES_DIR = FilePath(os.path.join(SYSTEM_DATA_DIR, THEME_DIRNAME))
SYSTEM_VIEWS_DIR = FilePath(os.path.join(SYSTEM_DATA_DIR, VIEW_DIRNAME))

SYSTEM_DEFAULT_THEME_FILE = SYSTEM_THEMES_DIR.joinpath("default.yaml")
...
SYSTEM_CMT_CONFIG_FILE = SYSTEM_CMTDIR.joinpath(CMT_CONFIG_FILENAME)

CMT_CONFIG_FILE_DIRNAME = f"{CMT_CONFIG_FILENAME}.d"
CMT_CONFIG_FILE_DIR = CMTDIR.joinpath(CMT_CONFIG_FILE_DIRNAME)
SYSTEM_CMT_CONFIG_FILE_DIR = SYSTEM_CMTDIR.joinpath(CMT_CONFIG_FILE_DIRNAME)
